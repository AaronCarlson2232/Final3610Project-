...
% Solution:
nb.initUltrasonic1('?', '?'); % Fill in with your ultrsonic trigger and echo pins
...
while (true)
    ...
    relBright = round('?'); % linear interpolation based on custom data. 
