...
learnRate = .00001; % how quickly network makes changes and learns
...
xTestLive(1,:,:,1) = rand(1,1); % YOU SHOULD MODIFY THIS LINE TO MATCH THE
                                % TYPE OF TRAINING USED ABOVE (FEATURES)
xTestLive(2,:,:,1) = rand(1,1); % YOU SHOULD MODIFY THIS LINE TO MATCH THE
                                % TYPE OF TRAINING USED ABOVE (FEATURES)
xTestLive(3,:,:,1) = rand(1,1); % YOU SHOULD MODIFY THIS LINE TO MATCH THE
                                % TYPE OF TRAINING USED ABOVE (FEATURES)
